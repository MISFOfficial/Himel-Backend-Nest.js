...
export default function Services() {
  ...
  return (
    <section id="services" className="">
      <div className="primary-color primary-rounded overflow-hidden relative min-h-[500px] flex items-center justify-between px-6 py-12 lg:px-20 lg:py-16">
        {/* Left Side - Image */}
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left text-white z-10 gap-8">
          ...
          <button
            ...
            className="bg-white text-black px-8 py-4 primary-rounded font-bold text-sm md:text-base uppercase tracking-wider hover:bg-gray-100 transition-all shadow-xl hover:shadow-2xl transform hover:-translate-y-1"
          >
